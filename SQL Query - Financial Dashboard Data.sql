...
COPY cc_detail
FROM 'D:\Power BI\Dataset\Credit_Card_Financial_Dashboard-main\Credit_Card_Financial_Dashboard-main\credit_card.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'D:\Power BI\Dataset\Credit_Card_Financial_Dashboard-main\Credit_Card_Financial_Dashboard-main\customer.csv' 
DELIMITER ',' 
CSV HEADER;
